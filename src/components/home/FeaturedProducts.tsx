...
const placeholderProducts = [
  ...
  { id:"4", slug:"coach-jacket", name:"Coach Jacket", price:40000, category:"Jackets", front_image:"https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=600&q=80", back_image:"https://images.unsplash.com/photo-1594938298603-c8148c4b4267?w=600&q=80", is_featured:true, is_published:true, sizes:["S","M","L","XL"], colors:["Black","Navy"], description:"Lightweight coach jacket", stock:20, model_url:null, created_at:new Date().toISOString() },
];
