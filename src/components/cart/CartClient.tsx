    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="flex items-center gap-4 mt-4">
                ...
                <div className="flex items-center gap-2 border border-base9-gray-300">
                  <button
                    ...
                    className="p-2 hover:bg-base9-gray-100 transition-colors"
      ...
      <div className="lg:col-span-1">
        <div className="bg-base9-gray-100 p-6 sticky top-24">
          <h2 className="text-sm font-bold text-base9-black mb-6 tracking-widest uppercase">
            Order Summary
          </h2>
          ...
          <div className="space-y-3 mb-6 pb-6 border-b border-base9-gray-200">
            <div className="flex justify-between text-sm">
              ...
              <span className="text-base9-black">${totalPrice.toFixed(2)}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-base9-gray-500">Shipping</span>
              <span className="text-base9-black">
          ...
          <div className="flex justify-between text-base mb-6">
            ...
            <span className="font-bold text-base9-black">
